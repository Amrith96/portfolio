...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={sectionRef} style={{ background: '#0a0a0a', padding: '96px 32px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr', gap: 64, alignItems: 'center' }} className="lg:grid-cols-2">
        ...
        <div>
          <motion.p
            ...
            style={{ color: '#E8000B', fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 24 }}
          >
            / About Me
          </motion.p>
          ...
          <div className="bebas" style={{ fontSize: 'clamp(3rem, 8vw, 6rem)', lineHeight: 0.9, color: '#F5F5F0' }}>
            {[
              { text: 'I AM', delay: 0 },
              { text: <span>AMRITH RAJ<span style={{ color: '#E8000B' }}>,</span></span>, delay: 0.1 },
              { text: 'AN AI AUTOMATION', delay: 0.2 },
              { text: <span>ENGINEER<span style={{ color: '#E8000B' }}>.</span></span>, delay: 0.3 },
            ].map((line, i) => (
              <motion.div
                key={i}
          ...
          <motion.div
            ...
            style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 520 }}
          >
          ...
          >
            <div style={{ width: 64, height: 64, borderRadius: '50%', overflow: 'hidden', border: '2px solid rgba(232,0,11,0.4)', flexShrink: 0 }}>
              <img
        ...
        <div>
          {[
            ...
            >
              <p style={{ fontSize: 10, letterSpacing: '0.2em', color: '#555', textTransform: 'uppercase', marginBottom: 8 }}>{fact.label}</p>
